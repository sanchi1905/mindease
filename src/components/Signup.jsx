...
export default function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const errorMsg = `Failed to create an account: ${error.message}`;
      setError(errorMsg);
      toast.error(errorMsg);
    }
      ...
      >
        <Card className="glass-card shadow-2xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl font-bold gradient-text">Join MindEase</CardTitle>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Start your wellness journey today</p>
          </CardHeader>
          <CardContent>
            {error && (
              <motion.div
